    ...
    <div class="row">
      <div class="col-md-12">
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/logo.png" alt="pipilikapay icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_pipilikapay_they_will_be_automaticly_added_into_your_account"), 'pipilikapay')?></small></p>
        </div>
