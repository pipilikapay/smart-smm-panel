            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  <hr>
                  <div class="form-group">
                    <label class="form-label">PipilikaPay API Key<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][api_key]" value="<?php echo (isset($option->api_key)) ? $option->api_key : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">PipilikaPay SECRET KEY<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    <label class="form-label">PipilikaPay PANEL URL<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][panel_URL]" value="<?php echo (isset($option->panel_URL)) ? $option->panel_URL : ''; ?>">
                  </div>
                  <div class="form-group">
                    <label class="form-label">USD Convert Rate<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][convert_rate]" value="<?php echo (isset($option->convert_rate)) ? $option->convert_rate : ''; ?>">
                  </div>
                </div>
